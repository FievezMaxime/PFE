...
// Vérification de la session (l'utilisateur est connecté si $_SESSION['user_id'] est défini)
...
$queryShips = "SELECT * FROM ships WHERE stock > 0";
...
<html lang="fr">
    <head>
        ...
        <title>Magasin - StarFarer Inc.</title>
            ...
            <div class="container">
                ...
                <div class="card-container">
                    <?php if(count($ships) > 0): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <p>Aucun vaisseau disponible actuellement.</p>
                    <?php endif; ?>
                </div>
            </div>
        </main>
